...
<head>
    ...
    <title>Votre Compte (Client) - Sportify</title>
...
<body>
    <div class="wrapper">
        ...
        <section class="section py-5">
            <div class="container">
                <h2 class="text-center">Votre Compte (Client)</h2>
                <div class="account-info mb-4">
                    ...
                    <p>Type de compte: Client</p>
                </div>
                <div class="client-actions my-4">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT a.appointment_id, a.appointment_date, a.address, a.document_requested, a.digicode, a.status, u.first_name, u.last_name
                                      FROM appointments a
                            ...
                            if ($result->num_rows > 0) {
                                while ($appointment = $result->fetch_assoc()) {
                                    ...
                                    echo '<td>';
                                    echo '<form action="../php/cancel_appointment.php" method="post" class="d-inline">';
